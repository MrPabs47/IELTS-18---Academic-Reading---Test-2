(function (global) {
  ...
  var TEST3_DETAILS = {
    ...
    19: ["The question refers to researchers working quickly because their evidence is disappearing. Paragraph B says glacial archaeologists need to ‘race the clock’ as the ice melts. This figurative expression matches the urgency in the statement, so the answer is B.", "Recognising a figurative phrase and its paraphrased meaning", "glacial archaeologists need to race the clock"],
