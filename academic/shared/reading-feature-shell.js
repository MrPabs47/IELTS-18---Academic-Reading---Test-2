(function (global) {
  ...
  var TEST3_DETAILS = {
    ...
    6: ["Warships were directly described as lightweight.", "Locating an exact word", "Warships were built to be lightweight"],
    7: ["The battering ram was made of bronze.", "Locating an exact word", "They had a bronze battering ram"],
    8: ["The trireme had rowers in top, middle, and lower levels.", "Using a summary clue", "rowers in the top, middle and lower levels"],
    9: ["Merchant ships had a wider hull.", "Using surrounding grammar", "They had a wider hull"],
    10: ["Merchant ships had square sails and a small triangular sail.", "Scanning for a contrast", "large square sails and a small triangular sail"],
    11: ["Music helped the rowers keep time together.", "Finding a stated detail", "music would be played on an instrument, and oars would then keep time with this"],
    12: ["Grain is the agricultural product named in the passage.", "Selecting a category example", "agricultural products (e.g. grain from Egypt’s Nile valley)"],
    13: ["Towboats dragged large merchant ships to the quay.", "Matching a paraphrase", "a number of towboats that would drag them to the quay"],
    14: ["Paragraph D explains why hunters could leave arrows and broken bows in the mountains.", "Matching information", "Hunters would have easily misplaced arrows and they often discarded broken bows rather than take them all the way home"],
    15: ["Paragraph C describes hiking with equipment and camping on permafrost.", "Matching information", "Fieldwork is hard work – hiking with all our equipment, often camping on permafrost"],
    16: ["Paragraph F links low temperatures with crop failures and greater reliance on hunting.", "Matching cause and effect", "supplement failing agricultural harvests in times of low temperatures"],
    17: ["Paragraph H says future archaeologists could extract artefacts from retreating ice.", "Finding a future possibility", "archaeologists could be extracting some of those artefacts from retreating ice in years to come"],
    18: ["Paragraph G names hides and antlers as goods linked to trade demand.", "Identifying examples", "a booming demand for hides to fight off the cold, as well as antlers"],
    19: ["Paragraph B says glacial archaeologists need to race the clock.", "Matching a paraphrase", "glacial archaeologists need to race the clock"],
    20: ["Organic materials decay unless protected from microorganisms.", "Using an exact noun", "protected from the microorganisms that cause decay"],
    21: ["Reindeer gathered on the ice patches in late summer.", "Locating a key noun", "Reindeer once congregated on these ice patches in the later summer months"],
    22: ["The reindeer gathered there to escape biting insects.", "Using an exact noun", "to escape biting insects"],
    23: ["The writer says hunters continued going into the mountains even during extreme cold.", "Checking writer claims", "hunters kept regularly venturing into the mountains even when the climate turned cold"],
    24: ["The team found lots of artefacts in some periods and few or none in others.", "Checking writer claims", "some periods had produced lots of artefacts"],
    25: ["Growing markets created a booming demand for hunting products, benefiting hunters.", "Finding a supported inference", "growing Norwegian towns, along with export markets, would have created a booming demand"],
    26: ["The discoveries show that goods travelled by overland routes as well as by ship.", "Rejecting an assumption", "plenty of goods travelled on overland routes"],
    27: ["The passage reports the discovery but gives no information about other scientists being surprised.", "Identifying missing information", "An international team of scientists led by the University of Cambridge has discovered"],
    28: ["Climate change is described as a major threat to the 2050 agricultural target.", "Matching a warning", "climate change is a major threat to achieving this"],
    29: ["Wheat and rice are explicitly described as sensitive to high temperatures.", "Matching a stated effect", "Key crops such as wheat and rice are sensitive to high temperatures"],
    30: ["The passage discusses thermal resilience, not crops requiring less water.", "Identifying missing information", "could help us breed tougher crops"],
    31: ["Plants in shade can grow faster to find sunlight again, so the statement is a contradiction.", "Checking a contrast", "enabling it to grow faster to find sunlight again"],
    32: ["Light-driven changes happen in less than a second, whereas night-time dark reversion is gradual.", "Comparing processes", "Light-driven changes to phytochrome activity occur very fast, in less than a second"],
