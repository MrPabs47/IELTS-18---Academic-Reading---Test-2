(function (global) {
  ...
  var TEST3_DETAILS = {
    ...
    33: ["The question asks for specialists able to use the findings. Paragraph H names outstanding collaborators who work on applied plant biology and can transfer the knowledge into the field. That practical role, rather than merely the research team, identifies H.", "Locating applied-research collaborators and their practical role", "outstanding collaborators nearby who work on more applied aspects of plant biology, and can help us transfer this new knowledge into the field"],
    34: ["The question asks for a possible benefit, not a description of the discovery. Paragraph D says identifying these molecules could accelerate breeding crops resilient to thermal stress and climate change. This clearly states a future practical benefit, so D is correct.", "Linking a stated research benefit to its application", "Discovering the molecules that allow plants to sense temperature has the potential to accelerate the breeding of crops resilient to thermal stress and climate change"],
    35: ["The question asks for scientific support for a traditional saying. Paragraph G explicitly says the discovery provides the science behind a well-known seasonal rhyme. This explanation of the rhyme, rather than only a reference to plant behaviour, makes G correct.", "Connecting explicit scientific validation to a traditional rhyme", "the discovery of the dual role of phytochromes provides the science behind a well-known rhyme long used to predict the coming season"],
    36: ["The question asks about people traditionally making plans from plant behaviour. Paragraph C says people have long used early budding after warm winters to predict weather and harvest times. It specifically links plant response to future planning, so C is correct.", "Tracing longstanding human use of plant behaviour", "warm winters cause many trees and flowers to bud early, something humans have long used to predict weather and harvest times for the coming year"],
    37: ["The question asks where the research was reported. Paragraph A says the new findings were published in the journal Science. This identifies the publication venue, rather than the researchers’ institution or the subject of the research, so A is correct.", "Finding the publication detail that reports the research", "The new findings, published in the journal Science, show that phytochromes control genetic switches in response to temperature as well as light to dictate plant development"],
    38: ["The sentence needs wording before “weather” and permits no more than two words. Paragraph G says daffodils can flower months in advance during a warm winter. “Warm” gives the natural phrase “warm weather”, while “warm winter” also remains within the word limit.", "Using gap grammar to select the temperature adjective", "Other species, such as daffodils, have considerable temperature sensitivity, and can flower months in advance during a warm winter"],
    39: ["The gap follows “in” and precedes a prediction of wet weather, so it needs a season. Paragraph G explains that a colder summer is likely to be rain-soaked. This supplies “summer” and satisfies the no-more-than-two-words limit.", "Mapping a seasonal condition to the sentence gap", "As the British know only too well, a colder summer is likely to be a rain-soaked one"],
    40: ["The gap follows “a particular species of” and needs the plant type used in the research. Paragraph H says the work used a mustard plant called Arabidopsis. The official answer key accepts “mustard”, “mustard plant”, and the grammatically appropriate plural “mustard plants”.", "Using noun grammar to choose the accepted plant term", "The work was done in a model system, using a mustard plant called Arabidopsis"]
  };
  ...
  function updateReviewFromOverlay() {
    ...
    if (studyReviewJustSubmitted) studyReviewSubmitted = true;
