...
(() => {
  ...
  window.IELTS16AcademicTest2StudyFeedback = {
    ...
    questions: {
      ...
      3: question(1, "trueFalseNotGiven", "TRUE", "TRUE", "The White Horse has recently been re-dated and shown to be even older than its previously assigned ancient pre-Roman Iron Age* date.", "recently been re-dated and shown to be even older than its previously assigned", "The statement says the earlier date for the Uffington White Horse was wrong. The passage says the horse was re-dated and shown to be older than its previously assigned Iron Age date, so the earlier date was indeed mistaken.", "Use comparison language to spot a correction to an earlier belief."),
      4: question(1, "trueFalseNotGiven", "FALSE", "FALSE", "While many historians are convinced the figure is prehistoric, others believe that it was the work of an artistic monk from a nearby priory", "While many historians are convinced the figure is prehistoric, others believe", "The statement says historians agree about the Long Man of Wilmington. The passage contrasts historians who think it is prehistoric with others who think a monk made it, so the claimed agreement is contradicted.", "Look for contrast markers that introduce opposing viewpoints."),
      ...
      14: question(2, "multipleChoice", "D", "D. They will continue to exist for longer than the human race.", "Microbes, most of them bacteria, have populated this planet since long before animal life developed and they will outlive us", "they will outlive us", "The writer says microbes existed before animal life and will outlive humans. This directly matches the option that they will continue to exist longer than the human race.", "Match a concise paraphrase."),
      15: question(2, "multipleChoice", "C", "C. the average individual has more microbial cells than human ones.", "while the number of human cells in the average person is about 30 trillion, the number of microbial ones is higher – about 39 trillion", "the number of microbial ones is higher", "The paragraph compares about 30 trillion human cells with about 39 trillion microbial cells in an average person. Because the microbial number is higher, the option about having more microbial cells than human ones is correct.", "Compare the two figures and identify the writer’s evaluation."),
      16: question(2, "multipleChoice", "A", "A. explaining how a discovery was made", "Using microscopes of his own design that could magnify up to 270 times, he examined a drop of water from a nearby lake and found it teeming with tiny creatures he called ‘animalcules’.", "Using microscopes of his own design", "The paragraph recounts how Leeuwenhoek used his own microscopes to examine water and discover tiny creatures. It explains how the discovery was made.", "For writer-purpose questions, identify the paragraph’s main function."),
      ...
      18: question(2, "summaryCompletionWordList", "B", "B. partnership", "we should realise we have a symbiotic relationship, that can be mutually beneficial or mutually destructive", "we have a symbiotic relationship", "The summary needs a word for the way humans and bacteria live in relation to each other. The passage calls it a symbiotic relationship, which the word-list option partnership best paraphrases.", "Translate an academic term into the closest word-list paraphrase."),
      ...
      20: question(2, "summaryCompletionWordList", "E", "E. cleanliness", "Our obsession with hygiene, our overuse of antibiotics and our unhealthy, low-fibre diets are disrupting the bacterial balance", "Our obsession with hygiene", "The passage lists an obsession with hygiene as one cause of disrupted bacterial balance. In the summary, cleanliness is the matching paraphrase for hygiene.", "Recognise synonym pairs in summaries."),
      21: question(2, "yesNoNotGiven", "YES", "YES", "the excessive use of household detergents and antibacterial products actually destroys the microbes that normally keep the more dangerous germs at bay.", "the excessive use of household detergents and antibacterial products", "The writer says that overusing these products can destroy helpful microbes that keep dangerous germs under control. That means the intended protective effect may fail.", "Follow the writer’s cause-and-effect claim."),
      ...
      27: question(3, "multipleChoice", "B", "B. A basic assumption about wisdom may be wrong.", "it isn’t an exceptional trait possessed by a small handful of bearded philosophers after all – in fact, the latest studies suggest that most of us have the ability to make wise decisions, given the right context", "it isn’t an exceptional trait possessed by a small handful", "A common assumption is that wisdom belongs only to a few exceptional people. The passage says studies suggest most people can make wise decisions in the right context, so that basic assumption may be wrong.", "Identify the belief that the writer corrects."),
      ...
      29: question(3, "multipleChoice", "B", "B. will be different in different circumstances.", "our ability to reason wisely depends on a variety of external factors.", "wisdom is not solely an “inner quality”", "Grossmann argues that wisdom is not simply a fixed inner quality but depends on the situations people are in. Therefore, the wisdom someone shows can differ across circumstances.", "Follow the central claim about context rather than personality."),
      ...
      33: question(3, "summaryCompletionWordList", "C", "C. view", "another is appreciation of perspectives wider than the issue at hand", "perspectives wider than the issue at hand", "The passage says wise reasoning includes appreciating perspectives wider than the immediate issue. In the summary, taking a broad view is the matching expression.", "Use collocation as a check when several options are semantically related."),
      34: question(3, "summaryCompletionWordList", "F", "F. objectivity", "when we adopt a third-person, ‘observer’ viewpoint we reason more broadly and focus more on interpersonal and moral ideals", "third-person, ‘observer’ viewpoint", "An observer viewpoint means looking at the situation with distance rather than from personal involvement. That detached perspective is why objectivity is the best word-list answer.", "Match an approach described in the passage with an abstract noun in the word list."),
      35: question(3, "summaryCompletionWordList", "G", "G. fairness", "we reason more broadly and focus more on interpersonal and moral ideals such as justice and impartiality", "justice and impartiality", "The observer viewpoint makes people focus on moral ideals such as justice and impartiality. Fairness is the word-list option that best summarises those ideals.", "Use the most inclusive synonym for two linked ideas."),
      36: question(3, "trueFalseNotGiven", "FALSE", "FALSE", "The students were instructed to imagine their career either ‘as if you were a distant observer’ or ‘before your own eyes as if you were right there’. Participants in the group assigned to the ‘distant observer’ role", "The students were instructed to imagine their career either", "The students did not choose a perspective. They were assigned to a distant-observer role or a control role. The statement says they could choose, so it is FALSE. ‘Were instructed’ describes what researchers told participants to do, not a free choice.", "Distinguish between being instructed or assigned and being allowed to choose."),
      ...
      38: question(3, "trueFalseNotGiven", "NOT GIVEN", "NOT GIVEN", "couples in long-term romantic relationships were instructed to visualize an unresolved relationship conflict either through the eyes of an outsider or from their own perspective", "couples in long-term romantic relationships", "The passage states that the participants were couples in long-term relationships and explains the viewpoint task they were given. It does not say that the length of the relationships affected the results, so that causal claim is NOT GIVEN.", "A participant characteristic is not automatically a cause of the result."),
      39: question(3, "trueFalseNotGiven", "TRUE", "TRUE", ["Participants in the group assigned to the ‘distant observer’ role displayed more wisdom-related reasoning", "Couples in the ‘other’s eyes’ condition were significantly more likely to rely on wise reasoning"], "displayed more wisdom-related reasoning", "In the job experiment, the distant-observer group displayed more wisdom-related reasoning. In the couples experiment, the outsider-perspective group was also more likely to rely on wise reasoning, so the statement matches both results.", "For ‘both’ statements, verify the evidence separately in each experiment."),
