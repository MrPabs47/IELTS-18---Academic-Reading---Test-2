...
(() => {
  ...
  window.IELTS16AcademicTest2StudyFeedback = {
    ...
    questions: {
      ...
      7: question(1, "trueFalseNotGiven", "TRUE", "TRUE", "the outlines would sometimes change ... creating a different shape to the original geoglyph", "the outlines would sometimes change", "The passage explicitly says that some outlines changed over hundreds of years and created a different shape. This matches the statement.", "Follow cause and result across a sentence."),
      ...
      11: question(1, "oneWordCompletion", "soil", "soil", "OSL testing was carried out ... on soil from two of the lower layers", "OSL testing was carried out", "The dating result came from OSL testing on soil taken from the horse’s lower layers. Therefore, soil completes the summary. After ‘analysis of the surrounding’, an uncountable material noun fits naturally.", "Use the words before the gap to predict the source material being analysed."),
      ...
      22: question(2, "yesNoNotGiven", "NO", "NO", "early exposure to a diverse range of bacteria ... may help protect them against allergies", "early exposure to a diverse range of bacteria", "The writer gives evidence that early contact with diverse bacteria may protect children against allergies. This contradicts the idea that children should meet as few bacteria as possible. ‘As few … as possible’ is an extreme minimising phrase.", "Look for the direct opposite of a quantity claim."),
      23: question(2, "yesNoNotGiven", "NOT GIVEN", "NOT GIVEN", "Among the less appealing case studies is one about a fungus ... Another is about squid", "Among the less appealing case studies", "The writer describes some case studies as less appealing, but does not say that there are too many of them. The claim about quantity is NOT GIVEN. ‘More … than are necessary’ needs quantity evidence, which the passage does not give.", "Do not infer a judgement about number from a judgement about appeal."),
      ...
      26: question(2, "yesNoNotGiven", "NO", "NO", "In the future ... we could construct buildings with useful microbes built into their walls", "In the future", "The statement says the microbes have already been put into hospital walls. The passage says this is a possible future development, so the statement is NO. ‘Could construct’ is a modal of possibility, not evidence that the buildings already exist.", "Check time references closely: future possibility versus completed present action."),
      ...
      28: question(3, "multipleChoice", "C", "C. The importance of certain influences on it was underestimated.", "experiential, situational, and cultural factors are even more powerful ... than previously imagined", "experiential, situational, and cultural factors are even more powerful", "Grossmann says that experience, situation and culture matter more than researchers had previously imagined. This means their importance was underestimated.", "Turn comparative language into a clear paraphrase."),
      ...
      30: question(3, "multipleChoice", "D", "D. a recommended strategy that can help people to reason wisely", "one of the most reliable ways to support wisdom ... is to look at scenarios from a third-party perspective", "one of the most reliable ways to support wisdom", "The paragraph recommends taking a third-party perspective as a way to support wiser decisions. It describes a helpful strategy. The pattern ‘one of the most reliable ways … is to + verb’ introduces recommended action.", "For purpose questions, look for recommendation language."),
      ...
      36: question(3, "trueFalseNotGiven", "FALSE", "FALSE", "The students were instructed to imagine their career either ‘as if you were a distant observer’ or ‘before your own eyes’", "The students were instructed to imagine their career either", "The students did not choose a perspective. They were assigned to a distant-observer role or a control role. The statement says they could choose, so it is FALSE. ‘Were instructed’ describes what researchers told participants to do, not a free choice.", "Distinguish between being instructed or assigned and being allowed to choose."),
